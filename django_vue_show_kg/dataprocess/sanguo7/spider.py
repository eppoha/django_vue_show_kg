...
# 请求地址
    ...
    url = 'https://baike.baidu.com/item/' + urllib.parse.quote(row[1])
    # 利用请求地址和请求头部构造请求对象
...
for row in result:
    ...
    path = pre_path + "\\" + row[1] + ".txt"
    # file = open(path, 'w+', encoding='utf-8')
    # file.write(text_all)
    # file.close()
    print("=========正在保存"+ row[1] + "的数据=========")
